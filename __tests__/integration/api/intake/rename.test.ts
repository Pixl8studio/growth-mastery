...
describe("PATCH /api/intake/rename", () => {
    ...
    it("should rename intake session successfully", async () => {
        const mockSupabase = {
            ...
            from: vi.fn((table: string) => ({
                ...
                single: vi.fn().mockResolvedValue({
                    data: { id: "intake-123", user_id: "user-123", session_name: "Old Name" },
                    error: null,
                }),
        ...
        const request = createMockRequest({
            method: "PATCH",
            body: { intakeId: "intake-123", sessionName: "New Name", projectId: "project-123" },
        });
    ...
    it("should return 400 for session name too long", async () => {
        const request = createMockRequest({
            method: "PATCH",
            body: { intakeId: "intake-123", sessionName: "x".repeat(300), projectId: "project-123" },
        });
