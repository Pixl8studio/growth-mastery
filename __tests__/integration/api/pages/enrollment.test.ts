/**
 * Enrollment Page API Integration Tests
 * Tests enrollment page update endpoints
 */

import { describe, it, expect, vi, beforeEach } from "vitest";
import { PATCH, PUT } from "@/app/api/pages/enrollment/[pageId]/route";
...
describe("PATCH /api/pages/enrollment/[pageId]", () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
...
describe("PUT /api/pages/enrollment/[pageId]", () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
