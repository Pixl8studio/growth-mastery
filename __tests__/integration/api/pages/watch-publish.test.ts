/**
 * Watch Page Publish API Integration Tests
 * Tests publish status toggle for watch pages
 */

import { describe, it, expect, vi, beforeEach } from "vitest";
import { POST } from "@/app/api/pages/watch/[pageId]/publish/route";
...
describe("POST /api/pages/watch/[pageId]/publish", () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });

    it("should publish a watch page successfully", async () => {
        const request = new NextRequest(
            "http://localhost:3000/api/pages/watch/test-page-id/publish",
            {
                method: "POST",
                body: JSON.stringify({
                    published: true,
    ...
    it("should unpublish a watch page successfully", async () => {
