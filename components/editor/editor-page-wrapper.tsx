...
export function EditorPageWrapper({
    ...
    useEffect(() => {
        ...
        const cssFiles = [
            "/funnel-system/assets/css/editor.css?v=2.0",
            "/funnel-system/assets/css/blocks.css?v=2.0",
            "/funnel-system/assets/css/component-library.css?v=2.0",
        ];
    ...
    return (
        <>
            ...
            <Script
                src="/funnel-system/assets/js/icon-mapper.js?v=2.0"
            ...
            <Script
                src="/funnel-system/assets/js/visual-editor.js?v=2.0"
                strategy="afterInteractive"
                onLoad={() => {
            ...
            />
            <Script
                src="/funnel-system/assets/js/component-library.js?v=2.0"
                strategy="afterInteractive"
                onLoad={() => {
