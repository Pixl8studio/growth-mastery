        ...
        <div className={cn("grid md:grid-cols-2 gap-6", className)}>
            ...
            <Card className="overflow-hidden">
                ...
                <div className="p-4 bg-gray-50">
                    ...
                    <div
                        className={cn(
                            "bg-white border rounded-lg overflow-auto transition-all",
                            emailView === "desktop"
                                ? "min-h-[400px]"
                                : "max-w-[375px] mx-auto"
                        )}
                            ...
                            <div className="bg-white rounded-[2rem] overflow-hidden h-[500px] flex flex-col">
                                ...
                                <div className="flex-1 p-4 bg-gray-50 overflow-auto">
                                    <div className="flex justify-end mb-2">
                                        <div className="max-w-[85%] bg-blue-500 text-white rounded-2xl rounded-tr-sm px-4 py-2 text-sm leading-relaxed">
                                            {smsBody}
                                        </div>
                                    </div>
