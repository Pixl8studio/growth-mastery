...
const STEPS: Step[] = [
    ...
    { number: 7, title: "Registration Page", shortTitle: "Register" },
    { number: 8, title: "Confirmation Page", shortTitle: "Confirm" },
    { number: 9, title: "Watch Page", shortTitle: "Watch" },
    { number: 10, title: "Enrollment Page", shortTitle: "Enroll" },
    { number: 11, title: "Call Booking Page", shortTitle: "Booking" },
    { number: 12, title: "Checkout Page", shortTitle: "Checkout" },
    { number: 13, title: "Upsell Page", shortTitle: "Upsell" },
    { number: 14, title: "Thank You Page", shortTitle: "Thanks" },
