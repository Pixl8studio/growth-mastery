 ...
 *
 * Connect and manage Instagram Business Account integration.
 */
...
export function InstagramIntegration({ projectId }: InstagramIntegrationProps) {
    ...
    const loadConnection = async () => {
        ...
        try {
            ...
            logger.error({ error, projectId }, "Failed to load Instagram connection");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleConnect = async () => {
        setConnecting(true);
        try {
            const redirectUri = `${window.location.origin}/api/funnel/${projectId}/integrations/instagram/callback`;
            const response = await fetch(
                `/api/funnel/${projectId}/integrations/instagram/connect?redirect_uri=${encodeURIComponent(redirectUri)}`
            );
    ...
    const handleDisconnect = async () => {
        try {
            ...
            logger.error({ error, projectId }, "Failed to disconnect Instagram");
            toast({
                title: "Error",
