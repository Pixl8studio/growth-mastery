...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                default:
                    "bg-primary text-primary-foreground hover:bg-primary/90 transition-smooth shadow-soft hover:shadow-float",
                destructive:
                ...
                hero: "gradient-emerald text-primary-foreground hover:shadow-glow transition-smooth font-semibold",
                premium:
                    "gradient-gold text-foreground hover:shadow-float transition-smooth font-semibold",
            },
            size: {
