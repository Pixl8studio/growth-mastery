...
ATTENTION → INTEREST → DESIRE → CONVICTION → ACTION
   │            │          │          │          │
   ▼            ▼          ▼          ▼          ▼
  Hero      Video/      Features   Founder    Pricing
            HowItWorks  (5 deep    Letter     + CTA
                        dives)     + FAQ
```

### Key Psychological Principles:

1. **Pattern Interrupt** (Hero) - Bold promise stops scroll
2. **Social Proof/Demonstration** (Video) - Shows real results
...
# 2. SECTION-BY-SECTION COPY FRAMEWORK
...
Paragraph 3: The outcome/transformation
```
...
4. **Solution Introduction** - What was built and why
5. **Mission Statement** - Bullet-pointed purpose
6. **Emotional Close** - Connection to larger movement
...
• So they can [POSITIVE_OUTCOME_1],
• [POSITIVE_OUTCOME_2],
• And [ASPIRATIONAL_VISION].
```
...
Price: $[X,XXX]
Tagline: The Complete [APPROACH] [CATEGORY]
Icon: ✨ (Sparkles)
Features: 6-8 items
Bottom Line: "You [ACTION]. The [TECHNOLOGY] does the heavy lifting."
CTA: "Get [TIER_NAME]"
```
...
Price: $[X,XXX]
Tagline: We [ACTION] the Entire [DELIVERABLE] For You
Icon: 🚀 (Rocket)
Features: 8-10 items (includes "Everything in [Tier 1]")
Bottom Line: "You give us your [INPUT]. We deliver a [ADJECTIVE] [OUTPUT]."
CTA: "Start My Done-For-You [DELIVERABLE]"
Badge: "RECOMMENDED"
```
...
Price: "Custom Quote"
Tagline: [WHITE_GLOVE_DESCRIPTION] for [TARGET_AUDIENCE]
Icon: 🏢 (Building)
Features: 8-10 items (includes "Everything in [Tier 2]")
Bottom Line: "A full-service [CATEGORY] partnership for [AUDIENCE]."
CTA: "Book [CONSULTATION_TYPE]"
```
...
- Unlimited revisions (specify timeframe)
- Priority support
...
CTA: Schedule [CALL_TYPE] Call
Alternative: Or email us at [EMAIL]
```
...
4. **Existing Assets** - "What if I already have [existing work]?"
...
```css
--gradient-hero: linear-gradient(135deg, hsl(48 38% 97%) 0%, hsl(145 40% 88%) 100%);
--gradient-emerald: linear-gradient(135deg, hsl(103 89% 29%) 0%, hsl(120 55% 55%) 100%);
--gradient-gold: linear-gradient(135deg, hsl(45 93% 58%) 0%, hsl(48 95% 68%) 100%);
--gradient-dark: linear-gradient(180deg, hsl(152 88% 15%) 0%, hsl(103 89% 29%) 100%);
```
...
py-32  /* 8rem / 128px - Hero on large screens */
```
...
max-w-6xl   /* Feature sections */
max-w-7xl   /* Pricing grid */
```
...
```css
--shadow-soft: 0 4px 20px hsl(103 89% 29% / 0.1);
--shadow-float: 0 8px 30px hsl(103 89% 29% / 0.15);
--shadow-glow: 0 0 40px hsl(120 55% 55% / 0.3);
```
...
- `animate-slide-up`: Staggered items (0.6s)
- `animate-pulse`: Indicators (default)
...
<div class="p-5 rounded-2xl bg-card/80 backdrop-blur-sm shadow-soft">
  <div class="flex items-center justify-between mb-2">
    ...
    <span class="text-accent font-semibold text-xs">+18%</span>
  </div>
  <p class="text-2xl font-bold text-foreground">45,200</p>
...
Paragraph 3: Outcome + Transformation
```
...
- "I can't afford ads" → Organic Engine
...
## Complete Variable Schema (YAML)

```yaml
# =============================================
# ENROLLMENT PAGE DATA SCHEMA
# All variables needed to generate a complete
# high-converting enrollment page
# =============================================

business:
  name: "GrowthMastery.ai"
...
brand:
  ...
  identity:
    ...
    target_audience: "founders, entrepreneurs, coaches"
...
offer:
  ...
  steps:
    ...
    - step_number: 2
      ...
      description: "See your entire funnel auto-generate in minutes"
      icon: "brain"
    - step_number: 3
      title: "Automate & Scale"
      description: "Automate all marketing that self-optimizes"
      icon: "zap"

features:
  # Each feature section
  - id: "marketing_engine"
    headline: "Your Entire Marketing Ecosystem"
    ...
    capabilities:
      ...
      - title: "Adaptive Ads Engine"
        description: "Launch meta-optimized ad campaigns"
        icon: "target"
  ...
  - id: "offer_optimizer"
    ...
    tagline: "Never guess what your market wants again."
    body_copy: "Our Offer Intelligence Engine continuously studies your business..."
    benefits:
      - "Refined positioning language that aligns with your voice"
      - "Optimized price points for maximum conversion"
      - "Clear launch readiness score"
    cta_text: "Generate Your Offer"
    layout: "visual-left"
    background: "bg-background"

  # Continue for all feature sections...
...
pricing:
  ...
  tiers:
    - name: "Launch Builder™"
      price: "$2,997"
      price_type: "one-time"
      tagline: "The Complete DIY Growth System"
      icon: "sparkles"
      recommended: false
      features:
        - "Full access to the GrowthMastery Launch System"
        - "Guided Intake & Offer Clarity Process"
    ...
    - name: "Launch Accelerator™"
      price: "$7,997"
      price_type: "one-time"
      tagline: "We Build the Entire Funnel For You"
      icon: "rocket"
      recommended: true
      features:
        - "Everything included in Launch Builder™"
        - "We complete your entire funnel"
        - "4 weekly 1:1 strategy calls"
    ...
    - name: "Enterprise Growth Suite™"
      price: "Custom Quote"
      price_type: "custom"
      tagline: "White-Glove Growth Engineering"
      icon: "building"
      recommended: false
      features:
        - "Everything included in Launch Accelerator™"
        - "Dedicated Success Architect"
        - "Team onboarding + training"
        - "Custom configurations"
        - "Multi-funnel orchestration"
      bottom_line: "Full-service partnership for scaling organizations."
      cta_text: "Book Enterprise Consultation"
...
faq:
  items:
    - question: "Do I have to switch CRMs?"
      answer: "No. GrowthMastery is CRM-agnostic..."
    - question: "What if I don't have an offer yet?"
      answer: "No problem - that's exactly what the system helps you create..."
    - question: "How fast can I launch?"
      answer: "Most founders launch in as little as 3 days..."
...
final_cta:
  ...
  trust_indicators:
    ...
    - icon: "🚀"
      text: "Launch in Days, Not Months"
...
```json
{
  ...
  "title": "EnrollmentPageData",
  "type": "object",
  "required": ["business", "brand", "offer", "pricing"],
  "properties": {
    "business": {
      "type": "object",
    ...
    "brand": {
      ...
      "properties": {
        "colors": {
          "type": "object",
          "properties": {
            "primary": { "type": "string", "description": "HSL format" },
            "accent": { "type": "string" },
    ...
    "pricing": {
      ...
      "properties": {
        ...
        "tiers": {
          ...
          "items": {
            "type": "object",
            "required": ["name", "price", "features", "cta_text"],
            "properties": {
              "name": { "type": "string" },
              "price": { "type": "string" },
              "tagline": { "type": "string" },
...
- [ ] Each feature section handles one objection
...
- [ ] Consultation escape valve present
...
business:
  name: "DataFlow.io"
  tagline: "The enterprise data pipeline that builds itself"

offer:
  transformation:
    before_state: "drowning in data silos and manual ETL"
    after_state: "unified data, real-time insights"
    timeframe: "hours, not quarters"
```
...
business:
  name: "CourseForge"
  tagline: "Turn your expertise into a profitable online course"

offer:
  transformation:
    before_state: "knowledge stuck in your head"
    after_state: "students paying to learn from you"
    timeframe: "weeks, not years"
```
...
business:
  ...
  tagline: "Done-for-you growth systems for 7-figure founders"

offer:
  transformation:
    before_state: "founder doing everything"
    after_state: "team-run growth machine"
    timeframe: "90 days"
```
