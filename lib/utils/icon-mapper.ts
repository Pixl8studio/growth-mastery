/**
 * Icon Mapper Utility
 * Maps emoji icons to Lucide icon names and provides SVG strings
 */

// Icon mapping from emojis to Lucide icon names
...
// Lucide SVG strings for vanilla JS use
export const ICON_SVG_STRINGS: Record<string, string> = {
    ...
    "file-stack":
        '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 2v5h5"/><path d="M21 6v6.5c0 .8-.7 1.5-1.5 1.5h-7c-.8 0-1.5-.7-1.5-1.5v-9c0-.8.7-1.5 1.5-1.5H17l4 4z"/><path d="M7 8v8.8c0 .3.2.6.4.8.2.2.5.4.8.4H15"/><path d="M3 12v8.8c0 .3.2.6.4.8.2.2.5.4.8.4H11"/></svg>',
    ...
    smartphone:
        '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="14" height="20" x="5" y="2" rx="2" ry="2"/><line x1="12" x2="12.01" y1="18" y2="18"/></svg>',
};
...
/**
 * Get SVG string for icon name (for vanilla JS use)
 */
export function getIconSvg(iconName: string): string {
    return ICON_SVG_STRINGS[iconName] || ICON_SVG_STRINGS["circle"];
}

/**
 * Convert emoji to SVG string directly
 */
export function emojiToSvg(emoji: string): string {
