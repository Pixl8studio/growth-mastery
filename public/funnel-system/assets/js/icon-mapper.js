...
// Map emojis to Lucide icon names
const ICON_MAP = {
    "🎯": "target",
    "📊": "bar-chart",
    "🎓": "graduation-cap",
...
const ICON_SVG_MAP = {
    ...
    'help-circle': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" x2="12.01" y1="17" y2="17"/></svg>',
 ...
 * Used by the toolbar to replace emojis with crisp SVG icons
 */
function emojiToSvg(emoji) {
    // Map emoji to icon name
    const iconName = ICON_MAP[emoji];

    if (iconName && ICON_SVG_MAP[iconName]) {
        // Return wrapped SVG for consistent sizing
        return `<span class="toolbar-icon-svg" style="width: 20px; height: 20px; display: inline-flex; align-items: center; justify-content: center;">${ICON_SVG_MAP[iconName]}</span>`;
    }
