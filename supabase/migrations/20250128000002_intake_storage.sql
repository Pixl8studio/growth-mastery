...
CREATE POLICY "Users can upload intake files" ON storage.objects
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY "Users can read their intake files" ON storage.objects
FOR SELECT
TO authenticated
USING (
    bucket_id = 'intake-files' AND
...
CREATE POLICY "Users can delete their intake files" ON storage.objects
FOR DELETE
TO authenticated
USING (
    bucket_id = 'intake-files' AND
